...
public class Route {
    ...
    public RouterFunction<ServerResponse> inventoryServiceRoute() {
        return GatewayRouterFunctions.route("inventory-service")
                .route(RequestPredicates.GET("api/inventory"), HandlerFunctions.http("http://localhost:8052"))
    ...
    public RouterFunction<ServerResponse> orderServiceRoute() {
        return GatewayRouterFunctions.route("order-service")
                .route(RequestPredicates.POST("api/order"), HandlerFunctions.http("http://localhost:8051"))
    ...
    public RouterFunction<ServerResponse> productServiceRoute() {
        return GatewayRouterFunctions.route("product-service")
                .route(RequestPredicates.GET("api/product"), HandlerFunctions.http("http://localhost:8050"))
    ...
    @Bean
        ...
        return GatewayRouterFunctions
                .route("fallbackRoute")
                .GET("/fallbackRoute", res -> ServerResponse.status(HttpStatus.SERVICE_UNAVAILABLE).body("service is nu available try again later !"))
                .build();
    }
}
